...
* Foi utilizada a API <a href="https://www.themoviedb.org/documentation/api?language=pt-BR" target="blank">The Movie DB</a> para fazer as requisições e pegar as informações dos filmes.

<h2>Link do deploy da aplicação: <a href="https://victor160997.github.io/clone-netflix/" target="blank">Clone Netflix.</a></h2>
